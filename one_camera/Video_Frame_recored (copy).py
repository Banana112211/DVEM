...
import os
import time
def videoaufzeichnung(video_wdth,video_hight,eingang,dir_path,queue,num_frames=100):
    import time
    ...
    os.chdir(dir_path) 
        # Time elapsed
    #ACHTUNG das Log_file wird nur erstellt wenn funktion komplett durch laeuft
