...
def get_ble_hr_mac():
    ...
    while 1:
        ...
        hci = pexpect.spawn("sudo hcitool lescan")
        try:
...
def main(addr=None, sqlfile=None, gatttool="sudo gatttool", check_battery=False, hr_handle=None, debug_gatttool=False):
    """
    ...
    while retry:
        ...
        while 1:
            ...
            gt = pexpect.spawn(gatttool + " -i hci0 -b D3:A1:A2:3C:06:CD -t random -I")
            if debug_gatttool:
